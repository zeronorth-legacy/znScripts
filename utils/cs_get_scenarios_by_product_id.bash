...
#
# Script to inventory all active Scenarios or Scenarios for a particular
# Product ID.
#
...
# Nothing to do.
if [ ! "$scns" ]; then
    zn_print_info "No matching Scenario. Exiting."
    exit
fi

# Print the column headings.
echo "Customer,ScenarioID,Product,ProductConfig,ScenarioName,Created(UTC)"
echo "$scns"
