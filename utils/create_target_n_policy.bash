...
# appropriate Scan Polcies using the specified Target and Policy names.
# If the named objects alredy exist, they are reused.
#
...
where,
  ...
  use parameters like the following to induce an straight import (bypassing
  the scan):

    {\"sonarqubeApplicationLookupType\":\"byKey\",\"projectKey\":\"My.Projec.Key\"}


  and for Black Duck Hub imports:

    {\"pullReport\":\"1\",\"project\":\"My-Project\",\"version\":\"This-Version\"}


  It may be necessary to enlose the JSON object string in single quotes:

    `basename $0 ` .... '{\"sonarqubeApplicationLookupType\":\"byKey\",\"projectKey\":\"My.Projec.Key\"}'
...
#CYBRIC_TARGET_SPEC="dummy"                     # use dummy for uploads
#TARGET_NAME_PREFIX="PnG_"
#POLICY_NAME_PREFIX="PnG_Nessus_"
